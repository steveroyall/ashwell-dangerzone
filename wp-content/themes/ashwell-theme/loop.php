...
<div role="main">
<div class="content">
<div class="mainContent equal"><?php /* Display navigation to next/previous pages when applicable */ ?>
...
<?php if ( ! have_posts() ) : ?>
		...
		<p><?php _e( 'Apologies, but no projects have been published yet. Coming soon.', 'twentyten' ); ?></p>
		<?php // get_search_form(); ?>
...
<!-- displays content on news page -->	
	
	<div class="result">
	
			<h2 class="postTitle"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'twentyten' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark"><?php the_title(); ?></a></h2>
			<?php // twentyten_posted_on(); ?>
