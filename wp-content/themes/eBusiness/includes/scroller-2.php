...
<div style="position: relative; z-index: 1;" id="slider-nav"> <a href="#" class="slider-link-1"><?php echo $ebusiness_slider_1_button; ?></a> <a href="#" class="slider-link-2"><?php echo $ebusiness_slider_2_button; ?></a> </div>
<div id="sections">
    <ul>
        <li>
