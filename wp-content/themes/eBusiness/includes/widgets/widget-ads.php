...
?>	
<div style="margin-left: -15px; width: 274px;">
<?php $i = 1; 
while ($i <= 8):
if ($bannerPath[$i] <> '') { ?>
<?php if ($bannerTitle[$i] == '') $bannerTitle[$i] = "advertisement";
	  if ($bannerAlt[$i] == '') $bannerAlt[$i] = "advertisement"; ?>
	<a href="<?php echo $bannerUrl[$i] ?>" <?php if ($new_window == 1) echo('target="_blank"') ?>><img class="ad_125" src="<?php if ($use_relpath == 1) bloginfo('url'); else echo $bannerPath[$i]; ?><?php if ($use_relpath == 1 ) echo ("/" . $bannerPath[$i]); ?>" alt="<?php echo $bannerAlt[$i]; ?>" title="<?php echo $bannerTitle[$i]; ?>" /></a>
<?php }; $i++;
endwhile; ?>
</div> <!-- end adwrap -->
<?php
  ...
  /*Creates the form for the widget in the back-end. */
    function form($instance){
		...
		<label for="<?php echo $this->get_field_id('use_relpath'); ?>"><?php echo('Use Relative Image Paths'); ?></label><br />
		...
		<label for="<?php echo $this->get_field_id('new_window'); ?>"><?php echo('Open in a new window'); ?></label><br /><br />
